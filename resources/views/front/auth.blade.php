    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 flex">
        ...
        <div class="w-1/2 border-r border-gray-400 mt-8 p-4">
            ...
            <form action="{{route('sign.in', request('subdomain'))}}" method="post">
                ...
                <div class="block mb-10">
                    ...
                    <input type="password" name="login[password]" value="{{old('login.password')}}"
                           class="w-full block">
                ...
                <button
                    class="text-xl font-bold px-4 py-2 rounded bg-green-600 text-white shadow hover:bg-green-300 transition ease-in-out delay-150 uppercase">
                    Login
                </button>
        ...
        <div class="w-1/2 ml-10 mt-8">
            ...
            <form action="{{route('sign.up', request('subdomain'))}}" method="post">
                ...
                <div class="block mb-10">
                    <label class="font-bold">Senha</label>
                    <input type="password" name="register[password]" value="{{old('register.password')}}"
                           class="w-full block">
                ...
                <div class="block mb-10">
                    ...
                    <input type="password" name="register[password_confirmation]"
                           value="{{old('register.password_confirmation')}}" class="w-full block">
                </div>
