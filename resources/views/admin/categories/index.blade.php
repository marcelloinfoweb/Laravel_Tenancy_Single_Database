                    ...
                    <div class="py-2 align-middle inline-block min-w-full">
                        <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                            <table class="w-full divide-y divide-gray-200">
                                ...
                                <tr>
                                    <th scope="col"
                                        class="font-semi px-6 py-4 text-center text-xs text-gray-500 uppercase tracking-wider">
                                        #
                                    </th>
                                    <th scope="col"
                                        class="font-semi px-6 py-4 text-center text-xs text-gray-500 uppercase tracking-wider">
                                    ...
                                    <th scope="col"
                                        class="w-48  px-6 py-4 text-center text-xs font-semi text-gray-500 uppercase tracking-wider">
                                        Ações
                                    </th>
                                </tr>
                                </thead>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="5"
                                            class="px-6 py-4 whitespace-nowrap text-sm text-center text-gray-500"><h3>
                                                Nenhum produto encontrado em sua loja</h3></td>
                                    </tr>
                                @endforelse
                                </tbody>
                            </table>
